        ...
        <div className="fixed inset-0 w-screen h-screen z-[9999] flex flex-col justify-end">
          ...
          <div className="relative w-[390px] h-[267px] bg-[#FFF] rounded-t-[40px] mx-auto px-[24px] pt-[12px] pb-[24px]">
            ...
            >
              ...
              <span
                className="text-[#6282E1] text-[18px] font-medium font-pretendard"
      ...
      <div className="max-w-[393px] mx-auto bg-white min-h-screen text-black">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center">
            <BackButton />
            <span
              className="ml-[12px] text-[20px] font-bold"
          ...
          <div className="flex items-start gap-[12px]">
            ...
            <div className="flex-1 mt-[10px] ml-[16px]">
              ...
              <div className="flex items-center justify-between">
                <span
                  className="text-[20px] font-semibold text-[#1F1F1F] font-pretendard"
                  style={{ fontWeight: 500 }}
                >
                  chaoni_gold
                </span>
              ...
              <div className="flex gap-[20px] mt-[8px]">
                <div className="flex items-center gap-[6px]">
                  <span className="text-[18px] text-[#B7B7B7] font-pretendard">
                    팔로워
                  </span>
                  <span
                    className="text-[20px] text-[#1F1F1F] font-pretendard"
                    style={{ fontWeight: 500 }}
                  >
                    31
                  </span>
        ...
        <div className="px-[20px]">
          ...
          <div className="flex justify-between px-[20px] py-[21px] bg-white rounded-[20px] shadow-[0px_2px_4px_rgba(0,0,0,0.15)] mb-[24px]">
            {summaryList.map((item, index) => (
              ...
              >
                ...
                <div
                  className="text-[18px] font-bold text-[#B7B7B7] font-pretendard"
                  style={{ fontWeight: 700 }}
                >
                  {item.count}
                </div>
          ...
          <div className="flex justify-between items-center mb-[12px]">
            <span
              className="text-[#6282E1] text-[18px] font-bold leading-[22px] font-pretendard"
              style={{ fontWeight: 700 }}
            >
              위시리스트
            </span>
