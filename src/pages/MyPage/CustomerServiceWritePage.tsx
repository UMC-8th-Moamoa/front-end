...
import { createCustomerInquiry, getMyUserId } from "../../services/mypage"; // ← fetchMyMerged 제거, getMyUserId 사용
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const msg =
        ...
        "등록 중 오류가 발생했습니다.";
      alert(msg);
      console.error("[CREATE_INQUIRY_ERROR]", err?.response || err);
    }
  };
    ...
    <div className="relative flex flex-col items-center bg-white max-w-[393px] min-w-[350px] min-h-screen mx-auto text-black pb-[120px]">
      ...
      <div className="w-[350px] flex flex-col gap-[4px] mt-6">
        ...
        <label className="flex items-center gap-2 mt-2 cursor-pointer">
          ...
          />
          <span className="text-[14px] font-pretendard text-[#B7B7B7]">동의합니다</span>
        </label>
      </div>
