    ...
    >
      <div className="flex w-[370px] gap-[16px]">
        ...
        <div className="flex flex-col justify-center gap-[6px]">
          <div className="text-[16px] font-semibold text-[#1F1F1F] font-pretendard">
            {title}
          </div>
      ...
      <div className="flex flex-col items-center w-full cursor-pointer">
        <div className="flex w-[370px] gap-[16px]">
          <div className="w-[80px] h-[80px] rounded-[4px] bg-[#F2F2F2] flex justify-center items-center">
            <img src={CameraIcon} alt="카메라 아이콘" className="w-[32px] h-[32px]" />
          </div>
          <div className="flex items-center font-pretendard text-[16px] font-semibold text-[#1F1F1F]">
            카메라 촬영
          </div>
        </div>
        <div className="h-[10px]" />
