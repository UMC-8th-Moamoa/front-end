...
export default function LetterContent({
 ...
 return (
  <div className="relative mt-[22px] w-[350px] h-[369px] mx-auto rounded-[20px] bg-[#F2F2F2]">
    {/* 입력창 + 카운트 텍스트 같이 감싸는 div */}
    <div className="relative w-full h-full rounded-[20px] bg-[#F2F2F2]">
      <textarea
        ref={textareaRef}
        className="
      ...
      <div className="absolute bottom-[10px] right-[12px] text-[12px] text-[#B7B7B7] font-pretendard">
