...
export default function FreeChargeSection() {
  return (
    <div className="px-5 py-4">
      ...
      {/* 광고 카드 */}
      <div className="flex items-center p-4 rounded-xl border border-[#E5E5E5]">
        {/* 왼쪽 아이콘 + 남은 횟수 */}
        <div className="flex flex-col items-center w-20 justify-center">
          <img src={AdIcon} alt="Ad icon" width={50} height={50} />
          <span className="text-xs text-[#97B1FF] font-medium mt-1">5/5</span>
        </div>
      ...
      <ul className="mt-6 text-[11px] text-[#B7B7B7] font-base leading-5 list-disc pl-4">
        ...
        <li>하루 최대 5회까지 광고 시청이 가능하며, 시청 가능 횟수는 매일 자정에 초기화됩니다.</li>
        <li>광고를 끝까지 시청하셔야 몽코인이 지급됩니다.</li>
        <li>네트워크 상태에 따라 광고 재생이 원활하지 않을 수 있으며, 이로 인해 충전에 제한될 수 있습니다.</li>
        <li>무료로 충전한 몽코인은 앱 내에서만 사용할 수 있으며, 현금화 및 환불이 불가합니다.</li>
      </ul>
    </div>
  );
}